...
class ReportExporter:
    ...
    def export_map_png(
        self,
        output_path: str,
        title: str = "Italian Minor Islands Coastal Risk",
        width_px: int = 1920,
        height_px: int = 1080,
        dpi: int = 150,
    ) -> bool:
    ...
    def _draw_overlay(self, img: QImage, title: str) -> QImage:
        ...
        painter.drawText(w - 260, h - 8, "Italian Minor Islands Coastal Risk — QGIS Plugin v1.6")
    ...
    def export_report_txt(
        ...
        lines += [
            ...
            "  Italian Minor Islands Coastal Risk — QGIS Plugin.",
