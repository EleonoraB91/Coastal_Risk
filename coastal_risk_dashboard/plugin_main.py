...
"""
plugin_main.py
Classe principale del plugin Italian Minor Islands Coastal Risk.
...
class CoastalRiskDashboard:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr("&Italian Minor Islands Coastal Risk")
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path=icon_path,
            text=self.tr("Italian Minor Islands Coastal Risk"),
            callback=self.run,
